...
var _dlgCommonTips = {
    ...
    lookHelpRecord:function(type,friName){
        var obj = getScInfo(type);
        return '<div class="inner-help-record"> <p>您为好友'+friName+'助力</p> <p>'+obj.name+'食材一份</p> <p class="key">美味值+'+obj.score+' </p><br><p>快来一起制作腊八粥</p><p>赢取8.8GB流量大奖吧！</p> <div class="sc-con icon-'+type+'"></div> <div class="btn-con"> <a href="javascript:;" class="btn btn-join"></a> </div> </div>';
    },
    // 好友成功增加美味值
